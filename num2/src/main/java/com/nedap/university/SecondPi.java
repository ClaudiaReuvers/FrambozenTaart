 ...
 */
public class SecondPi extends Thread {

    private DatagramSocket socket;
    private long nextAckExpected;
    private boolean connectionSetUp = false;

    SecondPi(int port) throws SocketException {
    ...
    public void run() {
        while (true) { //TODO: stop running
            ...
            if (receivedPacket.getLength() > 9) { //only send a response if the packet is not empty
