...
/**
 * Created by claudia.reuvers on 13/04/2017.
 */
public class SecondClient extends Thread {
    ...
    SecondClient(InetAddress connectingIP, int connectingPort) throws IOException {
    ...
    public void run() {
        ...
        while (true) { //TODO: stop running
            ...
            if (receivedPacket.getData().length > 9) { //only send a response if the packet is not empty
    ...
    private void sendSYN() {
        ...
        System.out.print("Send header: "); printHeader(new ExtraHeader(true, false, false, false, 0, seqNr));
